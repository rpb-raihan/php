...
<html lang="en">
  ...
  <body>
    ...
    <main class="mb-24">
      <section class="border border-red-700 w-4/5 mx-auto pb-12">
        <div class="w-4/5 border border-red-700 h-auto mt-20 my-4 mx-auto p-6">
  ...
  <div class="w-4/5 border border-red-700 h-auto mt-20 my-4 mx-auto p-6">
    ...
    <form method="POST" action="">
        ...
        <button type="submit" name="search" class="btn btn-accent">Search</button>
    </form>
    <div class="divider"></div>
    <?php
    // Database connection
    ...
    ?>
            ...
            <form method="POST" action="">
                ...
                <button type="submit" class="btn btn-error" name="delete">Delete</button>
            </form>
    <?php
        } else {
    ...
    ?>
        ...
        <div class="w-4/5 border border-red-700 h-auto my-4 mx-auto grid grid-cols-2">
        ...
        <ul>
            ...
            if (file_exists($tokenFile)) {
                ...
                if (isset($jsonData['token'])) {
                    foreach ($jsonData['token'] as $token) {
                        // Check if the token is not in the usedTokens array
                        if (!in_array((string)$token, $jsonData['usedTokens'])) {
    ...
    <div class="p-4 bg-slate-100">
        ...
        <ul>
            ...
            if (file_exists($tokenFile)) {
                ...
                if (isset($jsonData['usedTokens'])) {
                    foreach ($jsonData['usedTokens'] as $usedToken) {
          ...
          <div class="col-span-2 border border-red-800 h-auto">
            <form action="process.php" method="post" class="p-6 space-y-3">
              ...
              <input style="background-color: aquamarine;"
                ...
                class="border border-black w-4/5 h-8 rounded-xl px-4"
              />
              <select style="background-color: aquamarine;"
  name="bookName"
  required
  class="border border-black w-4/5 h-8 rounded-xl px-4"
>
  <option value="" disabled selected>Select a Book</option>
  <option value="The Great Gatsby">The Ship</option>
  <option value="To Kill a Mockingbird">Superman return</option>
  <option value="1984">The plan</option>
  <option value="Pride and Prejudice">forest</option>
</select>
              <input style="background-color: aquamarine;"
                type="number"
                required
